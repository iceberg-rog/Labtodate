...
import { reissueQuoteMagicLink } from '@/lib/quotes/actions';

export function QuoteReissueMagicLink({ quoteId }: { quoteId: string }) {
      ...
      <button
        ...
        onClick={() => {
          ...
          start(async () => {
            ...
            try {
              const r = await reissueQuoteMagicLink(fd);
              setMsg(r.message);
            } catch (e) {
